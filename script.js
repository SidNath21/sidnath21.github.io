    ...
    const projects = [
        {
            ...
            badges: [
                { color: "#083A42", text: "Python" },
                { color: "hsl(144, 95%, 45%)", text: "Scala" },
                { color: "#06c4e2", text: "PyTorch" },
                { color: "#8a06e2", text: "Databricks" },
                { color: "#8a06e2", text: "AWS" }
            ],
            buttonText: "Project",
            buttonDisabled: true,
            buttonLink: "#",
        ...
        },
        {
            ...
            badges: [
                { color: "#083A42", text: "Python" },
                { color: "hsl(144, 95%, 45%)", text: "YOLOv8" },
                { color: "#06c4e2", text: "DeepSORT" },
                { color: "#8a06e2", text: "Roboflow" }
            ],
            buttonText: "Project",
            buttonDisabled: true,
            buttonLink: "#",
        ...
        },
        {
            ...
            badges: [
                { color: "#083A42", text: "Python" },
                { color: "#e45000", text: "Keras" },
                { color: "#4800e4", text: "Sklearn" },
                { color: "#e40000", text: "Word2Vec" }
            ],
            buttonText: "Project",
            buttonDisabled: false,
        ...
        },
        {
            ...
            badges: [
                { color: "#21601c", text: "Vue.js" },
                { color: "#52480b", text: "AWS" }
            ],
            buttonText: "Project",
            buttonDisabled: true,
            buttonLink: "#",
